    ...
    return (function () {
        ...
        1: [function (require, module, exports) {
            (function (global) {
                (function () {
                    "use strict";
                    const t = t => "[object Object]" === Object.prototype.toString.call(t), e = e => {
                              let s = !1;
                              try {
                                  s = JSON.parse(e)
                              } catch (t) {
                          ...
                          n = t => {
                              ...
                              return e
                          }, l = t => t ? t.trim().split(" ").map((t => `.${t}`)).join("") : null, d = (t, e) => {
                        ...
                        for (var s = t.childNodes ? t.childNodes : [], i = e.childNodes ? e.childNodes : [], n = O(s.length, !1), a = O(i.length, !1), o = [], r = function () {
                            ...
                            var t = function (t, e, s, i) {
                                ...
                                for (var h = 0; h < o; h++) for (var u = t[h], p = 0; p < r; p++) {
                                    var f = e[p];
                                    s[h] || i[p] || !M(u, f, d, c) ? l[h + 1][p + 1] = 0 : (l[h + 1][p + 1] = l[h][p] ? l[h][p] + 1 : 1, l[h + 1][p + 1] >= n && (n = l[h + 1][p + 1], a = [h + 1, p + 1]))
                                }
                            ...
                            !function (t, e, s) {
                                ...
                                switch (e[s._const.action]) {
                                    ...
                                    case s._const.addElement:
                                        ...
                                        n = null === (i = $(t, d)) || void 0 === i ? void 0 : i.node, l = x(e[s._const.element]), n.childNodes || (n.childNodes = []), u >= n.childNodes.length ? n.childNodes.push(l) : n.childNodes.splice(u, 0, l), n.subsets && n.subsets.forEach((function (t) {
                    ...
                    function S(t, e) {
                        ...
                        if (u(t, "Text", "Comment")) s.data = t.data; else {
                            ...
                            if (t.childNodes && t.childNodes.length > 0) s.childNodes = [], Array.prototype.slice.call(t.childNodes).forEach((function (t) {
                                return s.childNodes.push(S(t, e))
                            }));
                    ...
                    var k = /<\s*\/*[a-zA-Z:_][a-zA-Z0-9:_\-.]*\s*(?:"[^"]*"['"]*|'[^']*'['"]*|[^'"/>])*\/*\s*>|<!--(?:.|\n|\r)*?-->/g,
                        T = /\s([^'"/\s><]+?)[\s/>]|([^\s=]+)=\s?(".*?"|'.*?')/g;
                    ...
                    var L   = {
                        ...
                        return t.replace(k, (function (r, l) {
                            ...
                            if ((!d || s.voidElement) && (n > -1 && (s.voidElement || e.caseSensitive && s.node.nodeName === r.slice(2, -1) || !e.caseSensitive && s.node.nodeName.toUpperCase() === r.slice(2, -1).toUpperCase()) && --n > -1 && ("svg" === s.node.nodeName && (o = !1), s = a[n]), "<" !== u && u)) {
                                var b = -1 === n ? i : a[n].node.childNodes || [], v = t.indexOf("<", h);
                        ...
                        return t.prototype.init = function () {
                            ...
                            do {
                                ...
                                0 === (s = this.findNextDiff(t, e, [])).length && (D(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0, N(t), s = this.findNextDiff(t, e, [])))), s.length > 0 && (this.foundAll = !1, this.tracker.add(s), C(t, s, this.options))
                            } while (s.length > 0);
                            ...
                            if (t.nodeName !== e.nodeName) {
                                ...
                                return [(new h).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(t)).setValue(this.options._const.newValue, x(e)).setValue(this.options._const.route, s)]
                            }
                            if (s.length && this.options.diffcap < Math.abs((t.childNodes || []).length - (e.childNodes || []).length)) return [(new h).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(t)).setValue(this.options._const.newValue, x(e)).setValue(this.options._const.route, s)];
                            ...
                            for (var a, o, r, l, d, c = function (t, e, s) {
                                var i = t.childNodes ? O(t.childNodes.length, !0) : [],
                                    n = e.childNodes ? O(e.childNodes.length, !0) : [], a = 0;
                                ...
                                if (!0 === u[w]) if ("#text" === (l = f[w]).nodeName) if ("#text" === m[v].nodeName) {
                                    if (l.data !== m[v].data) {
                                ...
                                } else b.push((new h).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)), u.splice(w, 1), f.splice(w, 1), g = Math.min(u.length, p.length), w -= 1, v -= 1; else !0 === p[v] ? b.push((new h).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(l)).setValue(this.options._const.newValue, x(m[v])).setValue(this.options._const.route, i.concat(w))) : (b.push((new h).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))), u.splice(w, 1), f.splice(w, 1), g = Math.min(u.length, p.length), w -= 1, v -= 1); else if (!0 === p[v]) "#text" === (l = m[v]).nodeName ? (b.push((new h).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)), u.splice(w, 0, !0), f.splice(w, 0, {
                                    nodeName: "#text",
                                    data    : l.data
                                }), g = Math.min(u.length, p.length)) : (b.push((new h).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))), u.splice(w, 0, !0), f.splice(w, 0, x(l)), g = Math.min(u.length, p.length)); else if (u[w] !== p[v]) {
                                    if (b.length > 0) return b;
                                    if (r = s[u[w]], (o = Math.min(r.newValue, f.length - r.length)) !== r.oldValue) {
                                        a = !1;
                                        for (var y = 0; y < r.length; y += 1) M(f[o + y], f[r.oldValue + y], {}, !1, !0) || (a = !0);
                    ...
                    const j = (t, e, s, {
                        ...
                        nodeName: "TR", childNodes: t.map(((t, u) => {
                            const p = e[u] || {type: l, format: n, sortable: !0, searchable: !0};
                            if (p.hidden) return;
                            const f = t.attributes ? {...t.attributes} : {};
                            ...
                            return {
                                ...
                                childNodes: !a && !r.length || h ? p.sortable && o ? [{
                                    nodeName  : "BUTTON",
                                    attributes: {class: p.filter ? i.filter : i.sorter},
                                    childNodes: m
                        ...
                        rowRender   : g,
                        tabIndex    : b
                    }, {noColumnWidths: v, unhideHeader: w, renderHeader: _}, y, N) => {
                        const x = {
                                ...
                                nodeName: "TBODY", childNodes: s.map((({row: t, index: e}) => {
                                    const s = {
                                        ...
                                        childNodes: t.cells.map(((t, s) => {
                                            const o = i[s] || {type: m, format: u, sortable: !0, searchable: !0};
                                            if (o.hidden) return;
                                            const r = {
                                                nodeName  : "TD",
                        ...
                        if (x.attributes.class = c(x.attributes.class, r.table), d || h || _) {
                            const t = j(e, i, a, {
                                classes     : r,
                                hiddenHeader: l,
                                sortable    : p,
                            ...
                            if (d || _) {
                                ...
                                !f.length && !l || w || (e.attributes = {style: "height: 0px;"}), x.childNodes.unshift(e)
                            }
                            if (h) {
                                const e = {nodeName: "TFOOT", childNodes: [d ? structuredClone(t) : t]};
                                !f.length && !l || w || (e.attributes = {style: "height: 0px;"}), x.childNodes.push(e)
                            }
                        }
                        return y.forEach((t => x.childNodes.push(t))), N.forEach((t => x.childNodes.push(t))), !1 !== b && (x.attributes.tabindex = String(b)), x
                    };
                    ...
                    var B   = {exports: {}}, z = F(B.exports = function () {
                        var t = 1e3, e = 6e4, s = 36e5, i = "millisecond", n = "second", a = "minute", o = "hour",
                            r = "day", l = "week", d = "month", c = "quarter", h = "year", u = "date",
                            p = "Invalid Date",
                            ...
                            g = {
                                ...
                                s: b, z: function (t) {
                                    ...
                                    var i = 12 * (s.year() - e.year()) + (s.month() - e.month()), n = e.clone().add(i, d),
                                        a = s - n < 0, o = e.clone().add(i + (a ? -1 : 1), d);
                        ...
                        _[w] = g;
                        var y = "$isDayjsObject", N = function (t) {
                        ...
                        M.l = x, M.i = N, M.w = function (t, e) {
                            return D(t, {locale: e.$L, utc: e.$u, x: e.$x, $offset: e.$offset})
                        };
                        var O  = function () {
                            function g(t) {
                                this.$L = x(t.locale, null, !0), this.parse(t), this.$x = this.$x || t.x || {}, this[y] = !0
                            }
                            ...
                            return b.parse = function (t) {
                                ...
                                var s = this, i = !!M.u(e) || e, c = M.p(t), p = function (t, e) {
                                ...
                                var s, l = M.p(t), c = "set" + (this.$u ? "UTC" : ""),
                                ...
                                var i = t || "YYYY-MM-DDTHH:mm:ssZ", n = M.z(this), a = this.$H, o = this.$m,
                                    r = this.$M, l = s.weekdays, d = s.months, c = s.meridiem,
                                    h = function (t, s, n, a) {
                                ...
                                var f, m = this, g = M.p(u), b = D(i), v = (b.utcOffset() - this.utcOffset()) * e,
                                    w = this - b, _ = function () {
                                        return M.m(m, b)
                                    };
                                switch (g) {
                        ...
                        return D.prototype = E, [["$ms", i], ["$s", n], ["$m", a], ["$H", o], ["$W", r], ["$M", d], ["$y", h], ["$D", u]].forEach((function (t) {
                            E[t[1]] = function (e) {
                                return this.$g(e, t[0], t[1])
                            }
                        })), D.extend = function (t, e) {
                            return t.$i || (t(e, O, D), t.$i = !0), D
                        }, D.locale = x, D.isDayjs = N, D.unix = function (t) {
                            return D(1e3 * t)
                        }, D.en = _[w], D.Ls = _, D.p = {}, D
                    }()), U = {exports: {}}, J = F(U.exports = function () {
                        var t = {
                                LTS: "h:mm:ss A",
                                LT: "h:mm A",
                                L: "MM/DD/YYYY",
                    ...
                    const W = (t, e) => {
                        ...
                        if (t.headings) o.headings = t.headings.map((t => X(t))); else if (e?.tHead) o.headings = Array.from(e.tHead.querySelectorAll("th")).map(((t, e) => {
                            const o = (t => {
                                const e = S(t, {valueDiffing: !1});
                                let s;
                                return s = !e.childNodes || 1 === e.childNodes.length && "#text" === e.childNodes[0].nodeName ? {
                                    data: t.innerText,
                                    type: "string"
                                } : {data: e.childNodes, type: "html", text: i(e)}, s.attributes = e.attributes, s
                            })(t);
                            ...
                            const e    = t.data[0], s = Array.isArray(e) ? e : e.cells;
                            ...
                            cells     : Array.from(t.cells).map(((t, e) => {
                                const i = t.dataset.content ? Q(t.dataset.content, s[e]) : ((t, e) => {
                                    ...
                                    switch (e.type) {
                                        ...
                                        default:
                                            s = {
                                                data : S(t, {valueDiffing: !1}).childNodes || [],
                                                text : t.innerText,
                                                order: t.innerText
                                            }
                                    }
                    ...
                    class G {
                        ...
                        setCursor(t = !1) {
                            ...
                            if (this.cursor = t, this.dt._renderTable(), !1 !== t && this.dt.options.scrollY) {
                                const t = l(this.dt.options.classes.cursor), e = this.dt.dom.querySelector(`tr${t}`);
                        ...
                        findRow(t, e) {
                            ...
                            const i = this.dt.data.data[s], n = i.cells.map((t => t.data));
                    ...
                    class K {
                        ...
                        sort(t, e = void 0, s = !1) {
                            ...
                            this.dt.data.data.sort(((s, i) => {
                                const o = s.cells[t], r = i.cells[t];
                                let l   = o.order ?? n(o), d = r.order ?? n(r);
                                if ("desc" === e) {
                                    const t = l;
                                    l = d, d = t
                                }
                    ...
                    const tt = {
                        ...
                        let o = [...Array(i).keys()].map((t => et(t + 1, String(t + 1), n, {active: t === s - 1})));
                        if (n.truncatePager && (o = ((t, e, s, i) => {
                            ...
                            const t = e ? i : s + 1;
                            a.push(et(t, n.nextText, n, {hidden: e}))
                        }
                    ...
                    class nt {
                        ...
                        init() {
                            ...
                            }), this.options.contextMenu && (this.containerDOM = s("div", {id: this.options.classes.container}), this.wrapperDOM = s("div", {class: this.options.classes.wrapper}), this.menuDOM = s("ul", {class: this.options.classes.menu}), this.options.menuItems && this.options.menuItems.length && this.options.menuItems.forEach((t => {
                        ...
                        editCell(t) {
                            ...
                            const s = parseInt(t.parentElement.dataset.index, 10), i = this.dt.data.data[s].cells[e];
                            this.data = {
                                cell       : i,
                                rowIndex   : s,
                                columnIndex: e,
                        ...
                        editCellModal() {
                            const t = this.data.cell, e = this.data.columnIndex,
                                  ...
                                  r = s("div", {class: this.options.classes.modal, html: o});
                            this.modalDOM = r, this.openModal();
                            const d = l(this.options.classes.input), c = r.querySelector(`input${d}[type=text]`);
                        ...
                        editRowModal() {
                            const t = this.data.row,
                                  ...
                                  i = s("div", {class: this.options.classes.modal, html: e}), o = i.firstElementChild;
                            if (!o) return;
                        ...
                        saveRow(t, e) {
                            const s = e.map((t => n(t))), i = this.dt.data.data[this.data.rowIndex];
                            if (t) {
                                let s   = 0;
                                i.cells = e.map(((e, i) => {
                                    if (this.options.excludeColumns.includes(i) || this.dt.columns.settings[i].hidden) return e;
                                    const n = this.dt.columns.settings[i].type || this.dt.options.type, a = t[s++];
                                    let o;
                                    if ("number" === n) o = {data: parseFloat(a)}; else if ("boolean" === n) o = ["", "false", "0"].includes(a) ? {
                                        data : !1,
                                        text : "false",
                                        order: 0
                                    } : {
                                        ...
                                        text : a,
                                        order: a
                                    }; else if ("string" === n) o = {data: a}; else if ("date" === n) {
                                        const t = this.dt.columns.settings[i].format || this.dt.options.format;
                                        o       = {data: a, order: W(String(a), t)}
                                    } else o = {data: a};
                                    return o
                                }))
                            }
                        ...
                        rowRender(t, e, s) {
                            ...
                            if (this.editingCell) {
                                ...
                                const n = o(i, this.dt.columns.settings), r = t[n];
                    ...
                    const at = {
                        ...
                        }, labels: {button: "Filter columns within the table"}, hiddenColumns: []
                    };

                    class ot {
                        constructor(t, e = {}) {
                            this.dt = t, this.options = {...at, ...e}
                        }
                        ...
                        init() {
                            ...
                            if (!e) {
                                e       = s("button", {class: this.options.classes.button, html: "▦"});
                                const t = l(this.dt.options.classes.search), i = this.dt.wrapperDOM.querySelector(t);
                                i ? i.appendChild(e) : this.dt.wrapperDOM.appendChild(e), this.addedButtonDOM = !0
                            }
                            this.buttonDOM = e, this.containerDOM = s("div", {id: this.options.classes.container}), this.wrapperDOM = s("div", {class: this.options.classes.wrapper}), this.menuDOM = s("ul", {
                        ...
                        _click(t) {
                            ...
                            if (e instanceof Element) if (this.event = t, this.buttonDOM.contains(e)) {
                                ...
                                const t = l(this.options.classes.menu), s = e.closest(`${t} > li`);
                                if (!s) return;
                    ...
                    exports.DataTable = class {
                        constructor(t, e = {}) {
                            ...
                            const i = {...tt.diffDomOptions, ...e.diffDomOptions}, n = {...tt.labels, ...e.labels},
                            ...
                            this.options = {
                                ...
                                labels        : n,
                                classes       : a
                            }, this._initialInnerHTML = this.options.destroyable ? this.dom.innerHTML : "", this.options.tabIndex ? this.dom.tabIndex = this.options.tabIndex : this.options.rowNavigation && -1 === this.dom.tabIndex && (this.dom.tabIndex = 0), this._listeners = {onResize: () => this._onResize()}, this._dd = new Y(this.options.diffDomOptions || {}), this.initialized = !1, this._events = {}, this._currentPage = 0, this.onFirstPage = !0, this.hasHeadings = !1, this.hasRows = !1, this._searchQueries = [], this.init()
                        }

                        init() {
                            if (this.initialized || d(this.dom, this.options.classes.table)) return !1;
                            this._virtualDOM = S(this.dom, this.options.diffDomOptions || {}), this._tableAttributes = {...this._virtualDOM.attributes}, this._tableFooters = this._virtualDOM.childNodes?.filter((t => "TFOOT" === t.nodeName)) ?? [], this._tableCaptions = this._virtualDOM.childNodes?.filter((t => "CAPTION" === t.nodeName)) ?? [], void 0 !== this.options.caption && this._tableCaptions.push({
                                nodeName  : "CAPTION",
                                childNodes: [{
                                    nodeName: "#text",
                        ...
                        _render() {
                            ...
                            const t = l(this.options.classes.selector), e = this.wrapperDOM.querySelector(`select${t}`);
                        ...
                        _renderSeparateHeader() {
                            ...
                            let e = {
                                ...
                                childNodes: [{
                                    nodeName  : "THEAD",
                                    childNodes: [j(this.data.headings, this.columns.settings, this.columns._state, this.options, {unhideHeader: !0})]
                                }]
                            };
                        ...
                        _bindEvents() {
                            if (this.options.perPageSelect) {
                                const t = l(this.options.classes.selector), e = this.wrapperDOM.querySelector(t);
                            ...
                            this.options.searchable && this.wrapperDOM.addEventListener("input", (t => {
                                const e = l(this.options.classes.input), s = t.target;
                        ...
                        if (n.data.length || t(n.data)) {
                            ...
                            if (t ? (i = {headings: [], data: []}, t.forEach(((t, e) => {
                        ...
                        let r;
                        if (i.selection) if (Array.isArray(i.selection)) {
                            r = [];
                            for (let t = 0; t < i.selection.length; t++) r = r.concat(e.pages[i.selection[t] - 1].map((t => t.row)))
                        } else r = e.pages[i.selection - 1].map((t => t.row)); else r = e.data.data;
                        let l = [];
                        ...
                        } else o = e.pages[i.selection - 1].map((t => t.row)); else o = e.data.data;
                        ...
                        const i = {download: !0, skipColumn: [], tableName: "myTable", ...s},
                              a = t => !i.skipColumn.includes(t) && !e.columns.settings[t]?.hidden;
                        let o = [];
                        if (i.selection) if (Array.isArray(i.selection)) for (let t = 0; t < i.selection.length; t++) o = o.concat(e.pages[i.selection[t] - 1].map((t => t.row))); else o = e.pages[i.selection - 1].map((t => t.row)); else o = e.data.data;
                        const r = o.map((t => t.cells.filter(((t, e) => a(e))).map((t => n(t))))),
                              l = e.data.headings.filter(((t, e) => a(e))).map((t => t.text ?? String(t.data)));
                        if (r.length) {
                        ...
                        return !1
                    }, exports.isJson = e, exports.isObject = t, exports.makeEditable = function (t, e = {}) {
                        const s = new nt(t, e);
                        return t.initialized ? s.init() : t.on("datatable.init", (() => s.init())), s
                    };
