...
@section('content')
    ...
    <div class="card card-filter">
        ...
        <div class="card-header">
            ...
            <div class="options">
                ...
                <div class="dropdown-menu dropdown-menu-right slideInUp">
                    <a class="dropdown-item" href="javascript:void(0);" data-toggle="modal" data-target="#mcv">
                        <i data-feather="tag"></i>
                        <span class="text-truncate pr-2" title="Seguridad">Nuevo valor</span>
                    </a>
        ...
        <div class="card-body" id="filter">
            ...
            <form class="custom-form" method="GET" action="{{ route('value.index') }}" autocomplete="off">
                                ...
                                <td class="text-right">
                                    <div class="button custom-dropdown-area dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right slideInUp" aria-labelledby="dropdownMenu">
                                            <a class="dropdown-item" href="{{ route('value.show', [$value->id]) }}">
                                                <i data-feather="sliders"></i>
                                                <span class="text-truncate pr-2">Parámetros</span>
                                            </a>
                                            <a class="dropdown-item" href="" data-toggle="modal" data-target="#edit-{{ $value->id }}">
                                    ...
                                    @push('modal')
                                        @include('quick::layouts.values.edit')
                                    @endpush
                                </td>
                            </tr>
                        @endforeach
    ...
    <div class="pagination d-flex justify-content-end pt-2">
        {!! $values->appends(request()->input())->links(); !!}
    </div>
...
@push('modal')
    @include('quick::layouts.values.create')
@endpush
